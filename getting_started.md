...
The ReliefWeb API was originally designed internally to help power a mobile web view of the http://ReliefWeb.INT website.  It has since been developed to allow for the public to access and make use of ReliefWeb data programatically.  
